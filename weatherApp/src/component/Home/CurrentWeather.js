...
const CurrentWeather = props => {
  ...
  return (
    <Paper className={classes.control}>
      <Grid container>
        <Grid item xs={12}>
          <Tooltip title={`lon: ${weather.coord.lon}, lat: ${weather.coord.lat}`} placement="bottom-start" interactive TransitionComponent={Zoom}>
        ...
        <Grid item xs={12} md={6} className={classes.box}>
          ...
          <Box>
            <List>
              ...
              <ListItem>
                <ListItemText primary={`${parseInt(weather.main.temp_max)} ${dimension}`} secondary="min" />
              </ListItem>
            </List>
          </Box>
          <Box>
